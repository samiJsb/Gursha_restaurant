...
const analyticsLive = [
  { name: 'Traditional', SalesValue: 12000, OrdersCount: 42 },
  { name: 'Sidamo Buna', SalesValue: 6200, OrdersCount: 154 },
  { name: 'Drinks/Juice', SalesValue: 3100, OrdersCount: 88 },
  { name: 'Kitfo Specialist', SalesValue: 18400, OrdersCount: 38 },
];

// Historical database values
const analyticsHistorical = [
  { name: 'Traditional', SalesValue: 184000, OrdersCount: 1240 },
  { name: 'Sidamo Buna', SalesValue: 84000, OrdersCount: 4100 },
  { name: 'Drinks/Juice', SalesValue: 42000, OrdersCount: 2200 },
  { name: 'Kitfo Specialist', SalesValue: 245000, OrdersCount: 1050 },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-4">
          ...
          >
            ...
            <div className="relative z-10">
              <span className="text-[9px] font-black text-zinc-500 uppercase tracking-widest block">Active Table Booking Sessions</span>
              <h4 className="text-2xl font-black font-mono text-white mt-2">
                {(344 * dynamicMultiplier).toLocaleString()} <span className="text-xs text-emerald-400">Patrons</span>
              </h4>
          ...
          <div className="p-8 bg-gradient-to-br from-amber-600 to-amber-400 text-black rounded-2xl overflow-hidden relative border border-amber-500/20 shadow-xl">
            <div className="relative z-10">
              ...
              <h3 className="text-sm font-black tracking-widest mb-1 uppercase">Store Efficiency</h3>
              <p className="text-black/70 text-[10px] uppercase font-bold tracking-widest mb-6 leading-relaxed">Preparation accuracy indices at 97.4%</p>
          ...
          <div className="p-6 bg-[#0B0B0E] border border-white/5 rounded-2xl relative overflow-hidden">
            <div className="flex justify-between items-center mb-6">
              <div className="space-y-1">
                ...
                <p className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest">Interactive distribution matrix across standard menu streams</p>
              </div>
            </div>
